...
def create_message_with_folder(sender, to, subject, html_content, folder_path):
...
def correo_exitoso():
    ...
    to_email = "reomir.negrete@record.com.co, soporte.rpa@record.com.co"
    ...
    message = create_message_with_folder(SENDER_EMAIL, to_email, email_subject, email_body, attachment_path)
